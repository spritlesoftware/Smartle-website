  ...
  <div className="lg:w-2/5 lg:pl-4 py-2 lg:py-0 flex flex-col justify-center">
    <div>
      ...
      <div className="py-3" style={{paddingLeft:"5%"}}>
        <p className="flex items-center mb-2">
          <i className="fas fa-phone mr-2" style={{color:'#226084'}}></i>
    ...
    <div>
      ...
      <div className="py-3 flex flex-col space-y-2 mb-2" style={{paddingLeft:"5%"}}>
        <a
          className="flex items-center" style={{color:'#226084'}}
        ...
        <a
          className="flex items-centere" style={{color:'#226084'}}
        ...
        >
          <i className="fas fa-flag  mr-2" style={{color:'#226084'}}></i>
