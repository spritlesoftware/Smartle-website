  ...
  <div className="container mx-auto sm:px-4 lg:flex-row flex flex-wrap">
    <div className="lg:w-3/5 pr-4 pl-4">
      ...
      >
        ...
        <button className="relative flex-grow max-w-full flex-1 px-4 inline-block align-middle text-center select-none border font-normal whitespace-no-wrap rounded py-1 px-3 leading-normal no-underline btn-dark-blue btn-rounded w-full" id="submit">
          Submit
        </button>
      </div>
    </div>
        ...
        <div className="py-3" style={{ paddingLeft: "5%" }}>
          ...
          <p>
            <i
              ...
              style={{ color: "#00356b", marginRight: "2%" }}
            />
            <span style={{ fontWeight: "bold" }}>Singapore:</span>&nbsp;+65 6652
            5475
          </p>
          <p>
            <i
              ...
              style={{ color: "#00356b", marginRight: "2%" }}
            />
            <span style={{ fontWeight: "bold" }}>Chennai, India:</span>&nbsp;+91
            44 4784 3003
          </p>
        </div>
      </div>
