...
const index = () => {
  ...
  return (
    <>
	  ...
	  <h3 className="text-2xl font-medium text-center pt-4 opacity-50">Smartle AI provides advanced CRM integration, expertly crafted to fit and <br /> enhance your business’s specific needs and objectives.</h3>
      {/* <div
    ...
    >
      <div className="flex h-full w-full flex-col items-stretch justify-between gap-10">
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div1Ref}>
            <FontAwesomeIcon icon={faHubspot} className="h-8 w-8 text-orange" />
          </Circle>
          <Circle ref={div5Ref}>
            <FontAwesomeIcon icon={faSalesforce} className="h-10 w-10 text-blue-500"  />
        ...
        <div className="flex flex-row items-center justify-between">
          <Circle ref={div2Ref}>
			<Image
           src="/images/crm/zendesk_icon.png"
          alt="zendesk_icon"
          height={1200}
          width={3000}
        />
