...
export default function HeroVideoDialog({
  ...
  const handleOverlayClick = (e: React.MouseEvent) => {
    // If the click target is the overlay itself, close the video
      ...
      <div className="relative cursor-pointer" onClick={openVideo}>
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          ...
          >
            ...
            >
              <PlayIcon
                className="size-8 text-navyblue"
                style={{
        ...
        {isVideoOpen && (
          ...
          >
            <motion.div
              ...
              className="relative w-full max-w-2xl aspect-video mx-4 md:mx-0"
            >
              <motion.button
                className="absolute -top-16 right-4 text-white text-xl bg-neutral-900/50 ring-1 backdrop-blur-md rounded-full p-2"
                onClick={closeVideo}
